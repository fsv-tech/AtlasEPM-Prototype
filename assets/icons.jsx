...
(function () {
  ...
  I.book       = svg('<path d="M4 4h12a3 3 0 0 1 3 3v13a2 2 0 0 0-2-2H4z"/><path d="M4 4v16h13a2 2 0 0 1 2 2"/><path d="M8 8h7M8 12h7"/>');
  I.command    = svg('<path d="M18 3a3 3 0 0 0-3 3v12a3 3 0 0 0 3 3 3 3 0 0 0 3-3 3 3 0 0 0-3-3H6a3 3 0 0 0-3 3 3 3 0 0 0 3 3 3 3 0 0 0 3-3V6a3 3 0 0 0-3-3 3 3 0 0 0-3 3 3 3 0 0 0 3 3h12a3 3 0 0 0 3-3 3 3 0 0 0-3-3z"/>');
  I.bookOpen   = svg('<path d="M12 7v14"/><path d="M12 7a4 4 0 0 0-4-4H3v14h5a4 4 0 0 1 4 4"/><path d="M12 7a4 4 0 0 1 4-4h5v14h-5a4 4 0 0 0-4 4"/>');
  I.coffee     = svg('<path d="M18 8h1a3 3 0 0 1 0 6h-1"/><path d="M3 8h15v9a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4z"/><path d="M6 2v3M10 2v3M14 2v3"/>');
  I.send       = svg('<path d="M22 2 11 13"/><path d="M22 2l-7 20-4-9-9-4z"/>');
  I.timer      = svg('<circle cx="12" cy="13" r="8"/><path d="M9 2h6M12 13V9"/>');
  I.link       = svg('<path d="M10 13a5 5 0 0 0 7 0l3-3a5 5 0 0 0-7-7l-1 1"/><path d="M14 11a5 5 0 0 0-7 0l-3 3a5 5 0 0 0 7 7l1-1"/>');
  I.tag        = svg('<path d="M20.6 13.4l-7.7 7.7a2 2 0 0 1-2.8 0L2 12.8V4h8.8l9.8 9.8a2 2 0 0 1 0 2.8z" transform="translate(0 -1)"/><circle cx="7" cy="7" r="1.2" fill="currentColor"/>');
